...
const loginpage = () => {
    ...
    const {signIn, signInAnonymous, currentUser, logOut} = useAuth();
                        ...
                        <div className="bg-slate-100 rounded-r-3xl w-full h-full">
                            <div>
                                ...
                                <div className="flex justify-center 
                                                ...
                                                lg:mt-[11%]
                                                md:mt-[13%]">
                                    <input ref={logEmailRef} className="xl:w-7/12 p-4 drop-shadow-lg text-lg rounded-xl border-4 border-black
                                ...
                                <div className="flex justify-center
                                                ...
                                                lg:mt-[11%]
                                                md:mt-[13%]">
                                    <button onClick={handleLogInWithEmail} className="xl:w-4/12 p-4 font-bold text-3xl rounded-2xl drop-shadow-kiddodropshadow bg-kiddoyellow hover:bg-kiddoyellowhover
                                ...
                                <div className="flex justify-center
                                                ...
                                                lg:mt-[7%]
                                                md:mt-[9%]">
                                    <button onClick={handleLogInAnonymous} className="xl:w-6/12 p-2 font-bold text-xl rounded-2xl drop-shadow-kiddodropshadow bg-kiddoyellow hover:bg-kiddoyellowhover
                                                    lg:w-7/12 p-1 font-bold rounded-xl drop-shadow-kiddodropshadow bg-kiddoyellow hover:bg-kiddoyellowhover
                                    ...
                                    <button onClick={handleLogOut} className="xl:w-6/12 p-2 font-bold text-xl rounded-2xl drop-shadow-kiddodropshadow bg-kiddoyellow hover:bg-kiddoyellowhover
                                                    lg:w-7/12 p-1 font-bold rounded-xl drop-shadow-kiddodropshadow bg-kiddoyellow hover:bg-kiddoyellowhover
                                                    md:w-8/12 p-1 font-bold rounded-xl drop-shadow-kiddodropshadow bg-kiddoyellow hover:bg-kiddoyellowhover">Log Out</button>
                                </div>
                            </div>
                        </div>
                    </div>
